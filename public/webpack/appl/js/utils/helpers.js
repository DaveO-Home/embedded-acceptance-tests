define("helpers", [
    ...
    "can-map"], function (moment, callbacks, Component, Map) {
            ...
            return {
                ...
                setJobTypeSelector: function (osKeys, values, template, baseUrl) {
...
/* develblock:start */
                ...
                isResolved: function isResolved(resolve, reject, selectorId, counter, children) {
                    ...
                    if (container && container.children.length > children) {
                        ...
                        if (counter > 5) {
                            ...
                            setTimeout(function () {
                                isResolved(resolve, reject, selectorId, counter, children);
                            }, time);
