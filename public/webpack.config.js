...
module.exports = {
    ...
    resolve: {
        ...
        alias: {
            ...
            apptests: path.resolve(__dirname, "webpack/tests/apptest"),
            contacttests: path.resolve(__dirname, "webpack/tests/contacttest"),
            domtests: path.resolve(__dirname, "webpack/tests/domtest"),
            logintests: path.resolve(__dirname, "webpack/tests/logintest"),
            routertests: path.resolve(__dirname, "webpack/tests/routertest"),
            toolstests: path.resolve(__dirname, "webpack/tests/toolstest")
        },
        modules: [
            path.resolve('./'),
    ...
    entry: [path.resolve(__dirname, './webpack/appl/index.js')],
    target: 'web',
    devServer: {
        host: "localhost",
        port: 3080
    ...
    output: {
        ...
        path: path.resolve(isProduction ? "dist/webpack" : 'dist_test/webpack'),
        publicPath: isProduction ? "/dist/" : devPublicPath,
        libraryTarget: "umd"
    },
    module: {
        rules: [
    ...
    plugins: [
        ...
        new CopyWebpackPlugin([
            {from: './webpack/images/favicon.ico', to: 'images'},
            {from: './webpack/appl/testapp.html', to: 'appl'},
            {from: 'README.md', to: ''}
//            {from: {
//                    glob: './webpack/appl/views/**/*',
//                    dot: false
//                },
//                to: 'appl'},
//            {from: {
//                    glob: './webpack/appl/templates/**/*',
//                    dot: false
//                },
//                to: 'appl'}
        ])
...
if (isProduction) {
    module.exports.plugins = (module.exports.plugins || []).concat([
        ...
        new webpack.optimize.UglifyJsPlugin({
            ...
            exclude: [excludeUglify, /\/node_modules/]
        }),
